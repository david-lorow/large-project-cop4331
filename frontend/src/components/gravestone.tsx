...
const Gravestone = ({ member }: MemberProps) => {
    return (
        ...
        <a href={member.linked} target="_blank" rel="noopener noreferrer" className="block">
            <div className="relative w-85 h-[500px] flex flex-col items-center group transition-transform duration-300 hover:-translate-y-4">
                ...
                <div className="relative z-10 flex flex-col items-center pt-24 w-full h-full px-8">
                    ...
                    <div className="text-center">
                        <p className="text-gray-400 text-[10px] tracking-[0.4em] uppercase opacity-80 mb-1">
                            Here Lies...
                        </p>
                        ...
                        <div className="flex flex-col gap-0.5">
                            {member.role.split(',').map((line, index) => (
                                <p 
                                    key={index} 
                                    className="text-[#8B0000] font-semibold italic text-[12px] tracking-wider uppercase opacity-90 leading-tight"
                                >
                                    {line.trim()}
                                </p>
                            ))}
